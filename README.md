...
* [Devops exercises](https://github.com/bregman-arie/devops-exercises) ⭐ 84,339 | 🐛 55 | 🌐 Python | 📅 2025-12-27, une collection d'exercices et de corrigés sur de nombreux sujets et technologies
...
* [Interop](https://github.com/web-platform-tests/interop) ⭐ 506 | 🐛 46 | 🌐 JavaScript | 📅 2026-08-26, groupe de travail spécialisé dans l'interopérabilité entre les navigateurs (implémentations des standards du web). Ce groupe maintient notamment [une suite de tests cross-browsers](https://github.com/web-platform-tests/wpt) ⭐ 6,126 | 🐛 2,807 | 🌐 HTML | 📅 2026-09-01
...
* [DarkMoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 885 | 🐛 2 | 🌐 Python | 📅 2026-08-29, plateforme open source française de test d'intrusion autonome pilotée par IA et hébergée sur votre propre infrastructure. Elle couvre le web, les API, l'Active Directory et Kubernetes via un serveur MCP. Éditée en France par ASC IT.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,980 | 🐛 3 | 🌐 Vue | 📅 2026-09-01, bibliothèque open source pour afficher du Markdown en flux continu dans les interfaces de chat IA ; compatible avec Vue/Nuxt, React, Svelte, Angular et Vue 2, avec Mermaid, KaTeX et coloration syntaxique.
...
* [typst](https://github.com/typst/typst) ⭐ 55,786 | 🐛 1,276 | 🌐 Rust | 📅 2026-09-01, langage markup destiné à produire des documents complets. Se place sur le même terrain que LaTeX.
...
* [Augmented Coding Patterns](https://lexler.github.io/augmented-coding-patterns/), une collection documentée de patterns dont s'inspirer dans un workflow basé sur l'interaction/intégration d'un LLM, guide/retex initialement écrit par [Lada Kesseler](https://github.com/lexler/augmented-coding-patterns) ⭐ 394 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-24;
...
* [tiny-gpu](https://github.com/adam-maj/tiny-gpu) ⭐ 12,894 | 🐛 43 | 🌐 SystemVerilog | 📅 2024-08-18, une implémentation GPU minimale pour apprendre le fonctionnement des GPU
* [Category Theory For Programmers](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,686 | 🐛 67 | 🌐 TeX | 📅 2026-07-10, de Bartosz Milewski
...
* [Category Theory](https://www.youtube.com/watch?v=I8LbkfSSR58\&list=PLbgaMIhjbmEnaH_LTkxLI7FMa2HsnawM_), de Bartosz Milewski. Pour les programmeur·ses. Passionant ! [Voir le dépôt associé (livre)](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,686 | 🐛 67 | 🌐 TeX | 📅 2026-07-10
...
* [Stacer](https://github.com/oguzhaninan/Stacer) ⭐ 9,317 | 🐛 173 | 🌐 C++ | 📅 2024-02-10, optimisation et monitoring de votre machine linux, avec une interface graphique sympa
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,993 | 🐛 105 | 📅 2026-08-21, le dépôt originel des dépôts listant des bonnes ressources sur des sujets intéressants
...
* [design resources for developer](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,799 | 🐛 107 | 📅 2026-05-24
* [Design Resources for developers](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,799 | 🐛 107 | 📅 2026-05-24,  un autre dépôt maintenant une liste de ressources pour le design/composants web
...
* [Web Development Resources You Ever Need](https://github.com/iamismile/web-dev-resources) ⭐ 782 | 🐛 1 | 📅 2026-09-01, un dépôt maintenant une liste de ressources pour le développement web
...
* [Damn Vulnerable Web Application](https://github.com/digininja/DVWA) ⭐ 13,584 | 🐛 7 | 🌐 PHP | 📅 2026-08-19, une application web PHP/MySQL extrêmement vulnérable. Son objectif principal est d'aider les professionnels de la sécurité à tester leurs compétences et leurs outils dans un environnement légal, d'aider les développeurs web à mieux comprendre les processus de sécurisation des applications web et d'aider à la fois les étudiants et les enseignants à apprendre la sécurité des applications web dans un environnement de classe contrôlé.

### Outils "*no code*", "*low code*" ou plutot *visual code*

* [awesome-nocode-lowcode](https://github.com/valentin-vogel/awesome-nocode-lowcode) ⭐ 416 | 🐛 20 | 📅 2026-08-09

### Côté client (*Front-end*)

* [front end  checklist](https://github.com/thedaviddias/Front-End-Checklist) ⭐ 74,006 | 🐛 7 | 🌐 MDX | 📅 2026-08-14, liste tout ce que vous devez pensez à checker sur votre front avant d'envoyer en prod
* [frontend dev bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,451 | 🐛 133 | 📅 2024-05-21, une liste de ressources de qualité pour les développeurs frontend
...
* [Frontend stuff](https://github.com/moklick/frontend-stuff) ⭐ 8,947 | 🐛 18 | 📅 2024-06-26, liste de tous les frameworks et libs côté client (CSS et JS surtout)
* [Jonas' Resources for Hand-Crafting Beautiful and Performant Websites](https://codingheroes.io/resources/)
* [omatsuri](https://omatsuri.app/)

### Développement de jeux vidéos

* [Magic tools](https://github.com/ellisonleao/magictools) ⭐ 17,232 | 🐛 15 | 🌐 Markdown | 📅 2026-08-29, un autre dépôt recenssant une tonne de ressources pour le développement de jeux vidéos (asset, code, design, outils, etc.)
* [GameDev Ressources](https://github.com/Kavex/GameDev-Resources) ⭐ 6,894 | 🐛 14 | 📅 2026-04-10, un dépôt recenssant une tonne de ressources pour le développement de jeux vidéos (asset, code, design, outils, etc.)
...
* [Awesome-Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 316,523 | 🐛 0 | 📅 2026-09-01, un dépôt qui liste des logiciels libres (free software) webs et réseau à herberger soi-même
...
* [Developers Conferences Agenda/List](https://github.com/scraly/developers-conferences-agenda) ⭐ 2,000 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-01, agenda des conférences tech dans le monde
...
* [Awesome MLOps](https://github.com/visenger/awesome-mlops) ⭐ 14,177 | 🐛 43 | 📅 2024-11-21

### Spécifique à une techno

#### PHP

* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,674 | 🐛 85 | 📅 2026-07-13, une liste organisée de ressources pour PHP (lib, books, podcasts, frameworks...)
...
* [awesome PHP security](https://github.com/guardrailsio/awesome-php-security) ⭐ 1,035 | 🐛 9 | 📅 2023-09-14, une liste organisée de ressources pour la sécurité des applications PHP
...
* [airbnb/javascript](https://github.com/airbnb/javascript) ⭐ 148,141 | 🐛 164 | 🌐 JavaScript | 📅 2026-04-16, le guide des bonnes pratiques JS d'airbnb
* [awesome-fp-js](https://github.com/stoeffel/awesome-fp-js) ⭐ 6,035 | 🐛 1 | 📅 2026-01-15, la même sur la programmation fonctionnelle
* [awesome-json](https://github.com/burningtree/awesome-json) ⭐ 1,565 | 🐛 98 | 📅 2026-06-19, la même sur des lib et ressources pour le json
...
* [awesome-flutter](https://github.com/Solido/awesome-flutter) ⭐ 61,069 | 🐛 40 | 🌐 Dart | 📅 2026-04-21, un dépôt qui maintient une liste filtrée de ressources pour Flutter

### Projets open-source

* [awesomo](https://github.com/lk-geimfari/awesomo) ⭐ 9,930 | 🐛 11 | 🌐 Go | 📅 2026-06-04, une liste de projets open-source intéressants (notamment si on veut se mettre à contribuer à l'open source)

### Design et architecture logicielle

* [awesome-design-patterns](https://github.com/DovAmir/awesome-design-patterns) ⭐ 48,762 | 🐛 25 | 📅 2024-10-25, des solutions réutilisables face à des problèmes courants d'architecture logicielle
* [A comprehensive list of books on Software Architecture](https://github.com/mhadidg/software-architecture-books) ⭐ 11,323 | 🐛 3 | 📅 2023-03-15

### Apprendre

* [build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) ⭐ 544,572 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14, des guides sélectionnés et corrigés pour recréer des logiciels que vous utilisez tous les jours (client BitTorrent, Bot, CLI, git, etc.). Vous permet de comprendre comment ces logiciels fonctionnent et d'apprendre des technos
* [The design system primer](https://github.com/donnemartin/system-design-primer) ⭐ 367,351 | 🐛 612 | 🌐 Python | 📅 2026-03-20, dépôt qui liste de nombreuses ressources pour apprendre à designer des systèmes informatiques sur le web. Focus sur la préparation aux entretiens
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 367,351 | 🐛 612 | 🌐 Python | 📅 2026-03-20, apprendre comment designer des grands systèmes d'information
* [project-based-learning](https://github.com/practical-tutorials/project-based-learning) ⭐ 281,695 | 🐛 277 | 🌐 Python | 📅 2026-08-31, une liste de tutoriels dans différents languages pour apprendre des technos sur des idées de projet
* [every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,367 | 🐛 25 | 📅 2025-12-29, un immense dépôt qui agrège une collection de savoirs techniques bon à connaître ou à découvrir lorsqu'on est développeur.
* [app-ideas](https://github.com/florinpop17/app-ideas) ⭐ 97,271 | 🐛 605 | 📅 2025-10-11, des idées d'applications à développer si on est en panne d'inspiration
* [professional-programming](https://github.com/charlax/professional-programming) ⭐ 51,469 | 🐛 7 | 🌐 Python | 📅 2026-07-15, collection de ressources pour apprendre sur tout un tas de sujets liés aux webs
* [awesome-guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 11,079 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-28, les standards d'écriture adapotés par chaque communauté (langage/techno)
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 474,181 | 🐛 1,859 | 🌐 Python | 📅 2026-08-31, une collection d'API publiques classées par thématique. Magnifique travail
...
* [developer roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 366,080 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-01, un dépôt qui propose des chemins d'apprentissage pour les différents postes du web
* [gitignore](https://github.com/github/gitignore) ⭐ 175,533 | 🐛 85 | 📅 2026-08-28, une collection de templates pour vos fichiers `.gitignore`
* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,204 | 🐛 257 | 📅 2024-06-25, s'améliorer en ligne de commande
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,607 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-01, un template de départ professionnel pour vos fichiers html
* [big-list-of-naughty-string](https://github.com/minimaxir/big-list-of-naughty-strings) ⭐ 47,704 | 🐛 108 | 🌐 Python | 📅 2024-04-18, un dépôt qui recense toutes les chaînes de caractères qui pourraient poser problème quand elles entrent dans votre application
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,755 | 🐛 82 | 🌐 Python | 📅 2026-09-01,  un dépôt qui héberge une tonne de bouquins techniques au format PDF maintenu par la [Free Ebook Foundation](https://ebookfoundation.org/)
* [free-programming-books en français](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-fr.md) ⭐ 395,755 | 🐛 82 | 🌐 Python | 📅 2026-09-01, même dépôt que précédemment mais listant que des livres de programmation en français !
* [papers we love](https://github.com/papers-we-love/papers-we-love) ⭐ 109,361 | 🐛 4 | 🌐 Shell | 📅 2026-08-31, un dépôt recensant et hébergeant (quand c'est possible) tout un tas d'articles sur l'informatique. Recense également une collection de sites pour trouver des papiers intéressants à lire
