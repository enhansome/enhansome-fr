...
* [Devops exercises](https://github.com/bregman-arie/devops-exercises) ⭐ 84,324 | 🐛 55 | 🌐 Python | 📅 2025-12-27, une collection d'exercices et de corrigés sur de nombreux sujets et technologies
...
* [Interop](https://github.com/web-platform-tests/interop) ⭐ 506 | 🐛 45 | 🌐 JavaScript | 📅 2026-08-26, groupe de travail spécialisé dans l'interopérabilité entre les navigateurs (implémentations des standards du web). Ce groupe maintient notamment [une suite de tests cross-browsers](https://github.com/web-platform-tests/wpt) ⭐ 6,126 | 🐛 2,803 | 🌐 HTML | 📅 2026-08-31
...
* [DarkMoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 883 | 🐛 2 | 🌐 Python | 📅 2026-08-29, plateforme open source française de test d'intrusion autonome pilotée par IA et hébergée sur votre propre infrastructure. Elle couvre le web, les API, l'Active Directory et Kubernetes via un serveur MCP. Éditée en France par ASC IT.
...
* [HAL Explorer](https://github.com/toedter/hal-explorer) ⭐ 177 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31, with HAL Explorer you can browse and explore HAL and HAL-FORMS based RESTful Hypermedia APIs. HAL Explorer was inspired by Mike Kelly’s HAL-Browser. HAL Explorer also supports Spring Profiles.
...
* [CommonMark](https://commonmark.org/), [une spécification Markdown](https://spec.commonmark.org/) créée en 2004 par John Gruber et Aaron Swartz, [implémentée dans de nombreux langages de programmation](https://github.com/commonmark/commonmark-spec/wiki/List-of-CommonMark-Implementations) ⭐ 5,139 | 🐛 130 | 🌐 Python | 📅 2026-04-27
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,977 | 🐛 2 | 🌐 Vue | 📅 2026-08-31, bibliothèque open source pour afficher du Markdown en flux continu dans les interfaces de chat IA ; compatible avec Vue/Nuxt, React, Svelte, Angular et Vue 2, avec Mermaid, KaTeX et coloration syntaxique.
...
* [typst](https://github.com/typst/typst) ⭐ 55,763 | 🐛 1,275 | 🌐 Rust | 📅 2026-08-31, langage markup destiné à produire des documents complets. Se place sur le même terrain que LaTeX.
...
* [tiny-gpu](https://github.com/adam-maj/tiny-gpu) ⭐ 12,887 | 🐛 43 | 🌐 SystemVerilog | 📅 2024-08-18, une implémentation GPU minimale pour apprendre le fonctionnement des GPU
* [Category Theory For Programmers](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,684 | 🐛 67 | 🌐 TeX | 📅 2026-07-10, de Bartosz Milewski
...
* [Category Theory](https://www.youtube.com/watch?v=I8LbkfSSR58\&list=PLbgaMIhjbmEnaH_LTkxLI7FMa2HsnawM_), de Bartosz Milewski. Pour les programmeur·ses. Passionant ! [Voir le dépôt associé (livre)](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,684 | 🐛 67 | 🌐 TeX | 📅 2026-07-10
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,708 | 🐛 105 | 📅 2026-08-21, le dépôt originel des dépôts listant des bonnes ressources sur des sujets intéressants
...
* [design resources for developer](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,791 | 🐛 106 | 📅 2026-05-24
* [Design Resources for developers](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,791 | 🐛 106 | 📅 2026-05-24,  un autre dépôt maintenant une liste de ressources pour le design/composants web
* [Awesome Web Development Resources](https://github.com/markodenic/web-development-resources) ⭐ 8,085 | 🐛 13 | 🌐 JavaScript | 📅 2026-06-09, un dépôt impressionant (et mieux organisé que celui-ci) référençant des tonnes de ressources pour le développement web
...
* [front end  checklist](https://github.com/thedaviddias/Front-End-Checklist) ⭐ 73,990 | 🐛 7 | 🌐 MDX | 📅 2026-08-14, liste tout ce que vous devez pensez à checker sur votre front avant d'envoyer en prod
* [frontend dev bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,447 | 🐛 133 | 📅 2024-05-21, une liste de ressources de qualité pour les développeurs frontend
...
* [Magic tools](https://github.com/ellisonleao/magictools) ⭐ 17,224 | 🐛 15 | 🌐 Markdown | 📅 2026-08-29, un autre dépôt recenssant une tonne de ressources pour le développement de jeux vidéos (asset, code, design, outils, etc.)
...
* [Awesome-Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 316,370 | 🐛 0 | 📅 2026-08-30, un dépôt qui liste des logiciels libres (free software) webs et réseau à herberger soi-même
...
* [Developers Conferences Agenda/List](https://github.com/scraly/developers-conferences-agenda) ⭐ 2,000 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-31, agenda des conférences tech dans le monde
...
* [Awesome MLOps](https://github.com/visenger/awesome-mlops) ⭐ 14,175 | 🐛 43 | 📅 2024-11-21
...
* [airbnb/javascript](https://github.com/airbnb/javascript) ⭐ 148,140 | 🐛 163 | 🌐 JavaScript | 📅 2026-04-16, le guide des bonnes pratiques JS d'airbnb
...
* [awesome-vue](https://github.com/vuejs/awesome-vue) ⭐ 73,548 | 🐛 101 | 📅 2026-07-24

#### Node.js

* [wesome-nodejs-security](https://github.com/lirantal/awesome-nodejs-security) ⭐ 3,033 | 🐛 13 | 📅 2026-08-14, la même sur des ressources pour sécuriser ses projets node.js

#### Flutter

* [awesome-flutter](https://github.com/Solido/awesome-flutter) ⭐ 61,064 | 🐛 40 | 🌐 Dart | 📅 2026-04-21, un dépôt qui maintient une liste filtrée de ressources pour Flutter
...
* [awesome-design-patterns](https://github.com/DovAmir/awesome-design-patterns) ⭐ 48,750 | 🐛 25 | 📅 2024-10-25, des solutions réutilisables face à des problèmes courants d'architecture logicielle
...
* [build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) ⭐ 544,333 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14, des guides sélectionnés et corrigés pour recréer des logiciels que vous utilisez tous les jours (client BitTorrent, Bot, CLI, git, etc.). Vous permet de comprendre comment ces logiciels fonctionnent et d'apprendre des technos
* [The design system primer](https://github.com/donnemartin/system-design-primer) ⭐ 367,041 | 🐛 613 | 🌐 Python | 📅 2026-03-20, dépôt qui liste de nombreuses ressources pour apprendre à designer des systèmes informatiques sur le web. Focus sur la préparation aux entretiens
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 367,041 | 🐛 613 | 🌐 Python | 📅 2026-03-20, apprendre comment designer des grands systèmes d'information
* [project-based-learning](https://github.com/practical-tutorials/project-based-learning) ⭐ 281,545 | 🐛 275 | 🌐 Python | 📅 2026-08-31, une liste de tutoriels dans différents languages pour apprendre des technos sur des idées de projet
* [every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,357 | 🐛 25 | 📅 2025-12-29, un immense dépôt qui agrège une collection de savoirs techniques bon à connaître ou à découvrir lorsqu'on est développeur.
* [app-ideas](https://github.com/florinpop17/app-ideas) ⭐ 97,244 | 🐛 605 | 📅 2025-10-11, des idées d'applications à développer si on est en panne d'inspiration
* [professional-programming](https://github.com/charlax/professional-programming) ⭐ 51,465 | 🐛 7 | 🌐 Python | 📅 2026-07-15, collection de ressources pour apprendre sur tout un tas de sujets liés aux webs
* [awesome-guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 11,076 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-28, les standards d'écriture adapotés par chaque communauté (langage/techno)
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 473,746 | 🐛 1,845 | 🌐 Python | 📅 2026-08-31, une collection d'API publiques classées par thématique. Magnifique travail
...
* [developer roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,993 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-21, un dépôt qui propose des chemins d'apprentissage pour les différents postes du web
* [gitignore](https://github.com/github/gitignore) ⭐ 175,523 | 🐛 84 | 📅 2026-08-28, une collection de templates pour vos fichiers `.gitignore`
* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,196 | 🐛 257 | 📅 2024-06-25, s'améliorer en ligne de commande
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,608 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-20, un template de départ professionnel pour vos fichiers html
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,680 | 🐛 83 | 🌐 Python | 📅 2026-08-30,  un dépôt qui héberge une tonne de bouquins techniques au format PDF maintenu par la [Free Ebook Foundation](https://ebookfoundation.org/)
* [free-programming-books en français](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-fr.md) ⭐ 395,680 | 🐛 83 | 🌐 Python | 📅 2026-08-30, même dépôt que précédemment mais listant que des livres de programmation en français !
* [papers we love](https://github.com/papers-we-love/papers-we-love) ⭐ 109,325 | 🐛 4 | 🌐 Shell | 📅 2026-08-31, un dépôt recensant et hébergeant (quand c'est possible) tout un tas d'articles sur l'informatique. Recense également une collection de sites pour trouver des papiers intéressants à lire
