...
* [Devops exercises](https://github.com/bregman-arie/devops-exercises) ⭐ 84,359 | 🐛 55 | 🌐 Python | 📅 2025-12-27, une collection d'exercices et de corrigés sur de nombreux sujets et technologies
...
* [Interop](https://github.com/web-platform-tests/interop) ⭐ 514 | 🐛 66 | 🌐 JavaScript | 📅 2026-09-03, groupe de travail spécialisé dans l'interopérabilité entre les navigateurs (implémentations des standards du web). Ce groupe maintient notamment [une suite de tests cross-browsers](https://github.com/web-platform-tests/wpt) ⭐ 6,135 | 🐛 2,799 | 🌐 HTML | 📅 2026-09-04
...
* [DarkMoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 889 | 🐛 2 | 🌐 Python | 📅 2026-08-29, plateforme open source française de test d'intrusion autonome pilotée par IA et hébergée sur votre propre infrastructure. Elle couvre le web, les API, l'Active Directory et Kubernetes via un serveur MCP. Éditée en France par ASC IT.
...
* [phpCodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,780 | 🐛 248 | 🌐 PHP | 📅 2024-04-01, l'outil par excellence pour appliquer des standards de manière semiautomatisé à son code source. Composé de deux programmes: phpcs pour sniffer les erreurs dans votre code et phpcbs pour corriger automatiquement ce qui peut l'être.
...
* [Docker Bench for Security](https://github.com/docker/docker-bench-security) ⭐ 9,697 | 🐛 29 | 🌐 Shell | 📅 2026-06-04, ensemble de scripts open-source qui permet d'auditer de manière automatique l'installation et la configuration du serveur Docker en environnement de production
...
* [Le Guide (fr)](https://github.com/bitemyapp/learnhaskell/blob/master/guide-fr.md) ⭐ 8,034 | 🐛 13 | 🌐 Makefile | 📅 2026-07-20
...
* [CommonMark](https://commonmark.org/), [une spécification Markdown](https://spec.commonmark.org/) créée en 2004 par John Gruber et Aaron Swartz, [implémentée dans de nombreux langages de programmation](https://github.com/commonmark/commonmark-spec/wiki/List-of-CommonMark-Implementations) ⭐ 5,140 | 🐛 130 | 🌐 Python | 📅 2026-04-27
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,986 | 🐛 4 | 🌐 Vue | 📅 2026-09-04, bibliothèque open source pour afficher du Markdown en flux continu dans les interfaces de chat IA ; compatible avec Vue/Nuxt, React, Svelte, Angular et Vue 2, avec Mermaid, KaTeX et coloration syntaxique.
...
* [typst](https://github.com/typst/typst) ⭐ 55,842 | 🐛 1,277 | 🌐 Rust | 📅 2026-09-03, langage markup destiné à produire des documents complets. Se place sur le même terrain que LaTeX.
...
* [tiny-gpu](https://github.com/adam-maj/tiny-gpu) ⭐ 12,914 | 🐛 43 | 🌐 SystemVerilog | 📅 2024-08-18, une implémentation GPU minimale pour apprendre le fonctionnement des GPU
* [Category Theory For Programmers](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,691 | 🐛 67 | 🌐 TeX | 📅 2026-07-10, de Bartosz Milewski
...
* [Category Theory](https://www.youtube.com/watch?v=I8LbkfSSR58\&list=PLbgaMIhjbmEnaH_LTkxLI7FMa2HsnawM_), de Bartosz Milewski. Pour les programmeur·ses. Passionant ! [Voir le dépôt associé (livre)](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,691 | 🐛 67 | 🌐 TeX | 📅 2026-07-10
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,987 | 🐛 106 | 📅 2026-09-02, le dépôt originel des dépôts listant des bonnes ressources sur des sujets intéressants
...
* [design resources for developer](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,830 | 🐛 112 | 📅 2026-05-24
* [Design Resources for developers](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,830 | 🐛 112 | 📅 2026-05-24,  un autre dépôt maintenant une liste de ressources pour le design/composants web
...
* [awesome-learning-resources](https://github.com/lauragift21/awesome-learning-resources) ⭐ 5,765 | 🐛 28 | 📅 2025-07-16
* [Web Development Resources You Ever Need](https://github.com/iamismile/web-dev-resources) ⭐ 784 | 🐛 2 | 📅 2026-09-01, un dépôt maintenant une liste de ressources pour le développement web
...
* [Damn Vulnerable Web Application](https://github.com/digininja/DVWA) ⭐ 13,603 | 🐛 7 | 🌐 PHP | 📅 2026-08-19, une application web PHP/MySQL extrêmement vulnérable. Son objectif principal est d'aider les professionnels de la sécurité à tester leurs compétences et leurs outils dans un environnement légal, d'aider les développeurs web à mieux comprendre les processus de sécurisation des applications web et d'aider à la fois les étudiants et les enseignants à apprendre la sécurité des applications web dans un environnement de classe contrôlé.

### Outils "*no code*", "*low code*" ou plutot *visual code*

* [awesome-nocode-lowcode](https://github.com/valentin-vogel/awesome-nocode-lowcode) ⭐ 416 | 🐛 21 | 📅 2026-08-09

### Côté client (*Front-end*)

* [front end  checklist](https://github.com/thedaviddias/Front-End-Checklist) ⭐ 74,034 | 🐛 7 | 🌐 MDX | 📅 2026-08-14, liste tout ce que vous devez pensez à checker sur votre front avant d'envoyer en prod
* [frontend dev bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,466 | 🐛 133 | 📅 2024-05-21, une liste de ressources de qualité pour les développeurs frontend
* [css-protips](https://github.com/AllThingsSmitty/css-protips) ⭐ 30,263 | 🐛 1 | 📅 2026-08-24, un dépôt qui documente tout un tas de conseils pour le CSS avec exemples à l'appui
...
* [Magic tools](https://github.com/ellisonleao/magictools) ⭐ 17,250 | 🐛 14 | 🌐 Markdown | 📅 2026-09-01, un autre dépôt recenssant une tonne de ressources pour le développement de jeux vidéos (asset, code, design, outils, etc.)
...
* [Awesome-Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 317,140 | 🐛 0 | 📅 2026-09-04, un dépôt qui liste des logiciels libres (free software) webs et réseau à herberger soi-même
...
* [Developers Conferences Agenda/List](https://github.com/scraly/developers-conferences-agenda) ⭐ 2,000 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-04, agenda des conférences tech dans le monde
...
* [Clean Code PHP](https://github.com/jupeter/clean-code-php) ⭐ 12,449 | 🐛 30 | 🌐 PHP | 📅 2024-05-09, des principes de clean code appliqués à PHP
...
* [airbnb/javascript](https://github.com/airbnb/javascript) ⭐ 148,147 | 🐛 164 | 🌐 JavaScript | 📅 2026-04-16, le guide des bonnes pratiques JS d'airbnb
* [awesome-fp-js](https://github.com/stoeffel/awesome-fp-js) ⭐ 6,037 | 🐛 1 | 📅 2026-01-15, la même sur la programmation fonctionnelle
* [awesome-json](https://github.com/burningtree/awesome-json) ⭐ 1,564 | 🐛 101 | 📅 2026-06-19, la même sur des lib et ressources pour le json
...
* [awesome-flutter](https://github.com/Solido/awesome-flutter) ⭐ 61,094 | 🐛 22 | 🌐 Dart | 📅 2026-09-03, un dépôt qui maintient une liste filtrée de ressources pour Flutter
...
* [awesome-design-patterns](https://github.com/DovAmir/awesome-design-patterns) ⭐ 48,810 | 🐛 25 | 📅 2024-10-25, des solutions réutilisables face à des problèmes courants d'architecture logicielle
...
* [build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) ⭐ 545,209 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14, des guides sélectionnés et corrigés pour recréer des logiciels que vous utilisez tous les jours (client BitTorrent, Bot, CLI, git, etc.). Vous permet de comprendre comment ces logiciels fonctionnent et d'apprendre des technos
* [The design system primer](https://github.com/donnemartin/system-design-primer) ⭐ 367,916 | 🐛 613 | 🌐 Python | 📅 2026-03-20, dépôt qui liste de nombreuses ressources pour apprendre à designer des systèmes informatiques sur le web. Focus sur la préparation aux entretiens
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 367,916 | 🐛 613 | 🌐 Python | 📅 2026-03-20, apprendre comment designer des grands systèmes d'information
* [project-based-learning](https://github.com/practical-tutorials/project-based-learning) ⭐ 282,069 | 🐛 278 | 🌐 Python | 📅 2026-08-31, une liste de tutoriels dans différents languages pour apprendre des technos sur des idées de projet
...
* [app-ideas](https://github.com/florinpop17/app-ideas) ⭐ 97,338 | 🐛 605 | 📅 2025-10-11, des idées d'applications à développer si on est en panne d'inspiration
* [professional-programming](https://github.com/charlax/professional-programming) ⭐ 51,488 | 🐛 7 | 🌐 Python | 📅 2026-07-15, collection de ressources pour apprendre sur tout un tas de sujets liés aux webs
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 475,266 | 🐛 1,894 | 🌐 Python | 📅 2026-09-02, une collection d'API publiques classées par thématique. Magnifique travail
...
* [developer roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 366,309 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-04, un dépôt qui propose des chemins d'apprentissage pour les différents postes du web
* [gitignore](https://github.com/github/gitignore) ⭐ 175,588 | 🐛 79 | 📅 2026-09-04, une collection de templates pour vos fichiers `.gitignore`
* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,239 | 🐛 257 | 📅 2024-06-25, s'améliorer en ligne de commande
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,611 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-03, un template de départ professionnel pour vos fichiers html
* [big-list-of-naughty-string](https://github.com/minimaxir/big-list-of-naughty-strings) ⭐ 47,709 | 🐛 108 | 🌐 Python | 📅 2024-04-18, un dépôt qui recense toutes les chaînes de caractères qui pourraient poser problème quand elles entrent dans votre application
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,971 | 🐛 80 | 🌐 Python | 📅 2026-09-01,  un dépôt qui héberge une tonne de bouquins techniques au format PDF maintenu par la [Free Ebook Foundation](https://ebookfoundation.org/)
* [free-programming-books en français](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-fr.md) ⭐ 395,971 | 🐛 80 | 🌐 Python | 📅 2026-09-01, même dépôt que précédemment mais listant que des livres de programmation en français !
* [papers we love](https://github.com/papers-we-love/papers-we-love) ⭐ 109,447 | 🐛 4 | 🌐 Shell | 📅 2026-08-31, un dépôt recensant et hébergeant (quand c'est possible) tout un tas d'articles sur l'informatique. Recense également une collection de sites pour trouver des papiers intéressants à lire
