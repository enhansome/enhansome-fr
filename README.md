...
* [simple.css](https://github.com/kevquirk/simple.css) ⭐ 4,972 | 🐛 0 | 🌐 HTML | 📅 2026-07-19, un template css sans classe pour prototyper un site markup stylé rapidement.
...
* [Devops exercises](https://github.com/bregman-arie/devops-exercises) ⭐ 84,068 | 🐛 53 | 🌐 Python | 📅 2025-12-27, une collection d'exercices et de corrigés sur de nombreux sujets et technologies
...
* [Interop](https://github.com/web-platform-tests/interop) ⭐ 506 | 🐛 44 | 🌐 JavaScript | 📅 2026-08-10, groupe de travail spécialisé dans l'interopérabilité entre les navigateurs (implémentations des standards du web). Ce groupe maintient notamment [une suite de tests cross-browsers](https://github.com/web-platform-tests/wpt) ⭐ 6,097 | 🐛 2,814 | 🌐 HTML | 📅 2026-08-16
...
* [HAL Explorer](https://github.com/toedter/hal-explorer) ⭐ 177 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-16, with HAL Explorer you can browse and explore HAL and HAL-FORMS based RESTful Hypermedia APIs. HAL Explorer was inspired by Mike Kelly’s HAL-Browser. HAL Explorer also supports Spring Profiles.
...
* [Docker Bench for Security](https://github.com/docker/docker-bench-security) ⭐ 9,689 | 🐛 29 | 🌐 Shell | 📅 2026-06-04, ensemble de scripts open-source qui permet d'auditer de manière automatique l'installation et la configuration du serveur Docker en environnement de production
...
* [typst](https://github.com/typst/typst) ⭐ 55,479 | 🐛 1,273 | 🌐 Rust | 📅 2026-08-14, langage markup destiné à produire des documents complets. Se place sur le même terrain que LaTeX.
...
* [tiny-gpu](https://github.com/adam-maj/tiny-gpu) ⭐ 12,845 | 🐛 43 | 🌐 SystemVerilog | 📅 2024-08-18, une implémentation GPU minimale pour apprendre le fonctionnement des GPU
* [Category Theory For Programmers](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,673 | 🐛 67 | 🌐 TeX | 📅 2026-07-10, de Bartosz Milewski
...
* [Category Theory](https://www.youtube.com/watch?v=I8LbkfSSR58\&list=PLbgaMIhjbmEnaH_LTkxLI7FMa2HsnawM_), de Bartosz Milewski. Pour les programmeur·ses. Passionant ! [Voir le dépôt associé (livre)](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,673 | 🐛 67 | 🌐 TeX | 📅 2026-07-10
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,439 | 🐛 100 | 📅 2026-06-30, le dépôt originel des dépôts listant des bonnes ressources sur des sujets intéressants
...
* [design resources for developer](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,666 | 🐛 83 | 📅 2026-05-24
* [Design Resources for developers](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,666 | 🐛 83 | 📅 2026-05-24,  un autre dépôt maintenant une liste de ressources pour le design/composants web
* [Awesome Web Development Resources](https://github.com/markodenic/web-development-resources) ⭐ 8,082 | 🐛 8 | 🌐 JavaScript | 📅 2026-06-09, un dépôt impressionant (et mieux organisé que celui-ci) référençant des tonnes de ressources pour le développement web
...
* [front end  checklist](https://github.com/thedaviddias/Front-End-Checklist) ⭐ 73,539 | 🐛 6 | 🌐 MDX | 📅 2026-08-14, liste tout ce que vous devez pensez à checker sur votre front avant d'envoyer en prod
* [frontend dev bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,391 | 🐛 132 | 📅 2024-05-21, une liste de ressources de qualité pour les développeurs frontend
* [css-protips](https://github.com/AllThingsSmitty/css-protips) ⭐ 30,249 | 🐛 2 | 📅 2025-03-20, un dépôt qui documente tout un tas de conseils pour le CSS avec exemples à l'appui
* [Frontend stuff](https://github.com/moklick/frontend-stuff) ⭐ 8,954 | 🐛 17 | 📅 2024-06-26, liste de tous les frameworks et libs côté client (CSS et JS surtout)
* [Jonas' Resources for Hand-Crafting Beautiful and Performant Websites](https://codingheroes.io/resources/)
* [omatsuri](https://omatsuri.app/)

### Développement de jeux vidéos

* [Magic tools](https://github.com/ellisonleao/magictools) ⭐ 17,137 | 🐛 12 | 🌐 Markdown | 📅 2026-08-16, un autre dépôt recenssant une tonne de ressources pour le développement de jeux vidéos (asset, code, design, outils, etc.)
* [GameDev Ressources](https://github.com/Kavex/GameDev-Resources) ⭐ 6,857 | 🐛 9 | 📅 2026-04-10, un dépôt recenssant une tonne de ressources pour le développement de jeux vidéos (asset, code, design, outils, etc.)
...
* [Awesome-Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 313,036 | 🐛 0 | 📅 2026-08-16, un dépôt qui liste des logiciels libres (free software) webs et réseau à herberger soi-même
...
* [Developers Conferences Agenda/List](https://github.com/scraly/developers-conferences-agenda) ⭐ 1,995 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-16, agenda des conférences tech dans le monde
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,651 | 🐛 83 | 📅 2026-07-13, une liste organisée de ressources pour PHP (lib, books, podcasts, frameworks...)
...
* [airbnb/javascript](https://github.com/airbnb/javascript) ⭐ 148,147 | 🐛 162 | 🌐 JavaScript | 📅 2026-04-16, le guide des bonnes pratiques JS d'airbnb
...
* [awesome-flutter](https://github.com/Solido/awesome-flutter) ⭐ 60,929 | 🐛 38 | 🌐 Dart | 📅 2026-04-21, un dépôt qui maintient une liste filtrée de ressources pour Flutter
...
* [awesome-design-patterns](https://github.com/DovAmir/awesome-design-patterns) ⭐ 48,584 | 🐛 25 | 📅 2024-10-25, des solutions réutilisables face à des problèmes courants d'architecture logicielle
* [A comprehensive list of books on Software Architecture](https://github.com/mhadidg/software-architecture-books) ⭐ 11,294 | 🐛 3 | 📅 2023-03-15

### Apprendre

* [build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) ⭐ 540,191 | 🐛 629 | 🌐 Markdown | 📅 2026-07-14, des guides sélectionnés et corrigés pour recréer des logiciels que vous utilisez tous les jours (client BitTorrent, Bot, CLI, git, etc.). Vous permet de comprendre comment ces logiciels fonctionnent et d'apprendre des technos
* [The design system primer](https://github.com/donnemartin/system-design-primer) ⭐ 364,162 | 🐛 605 | 🌐 Python | 📅 2026-03-20, dépôt qui liste de nombreuses ressources pour apprendre à designer des systèmes informatiques sur le web. Focus sur la préparation aux entretiens
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 364,162 | 🐛 605 | 🌐 Python | 📅 2026-03-20, apprendre comment designer des grands systèmes d'information
* [project-based-learning](https://github.com/practical-tutorials/project-based-learning) ⭐ 279,436 | 🐛 267 | 🌐 Python | 📅 2026-08-10, une liste de tutoriels dans différents languages pour apprendre des technos sur des idées de projet
* [every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,246 | 🐛 25 | 📅 2025-12-29, un immense dépôt qui agrège une collection de savoirs techniques bon à connaître ou à découvrir lorsqu'on est développeur.
* [app-ideas](https://github.com/florinpop17/app-ideas) ⭐ 96,830 | 🐛 606 | 📅 2025-10-11, des idées d'applications à développer si on est en panne d'inspiration
* [professional-programming](https://github.com/charlax/professional-programming) ⭐ 51,409 | 🐛 6 | 🌐 Python | 📅 2026-07-15, collection de ressources pour apprendre sur tout un tas de sujets liés aux webs
* [awesome-guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 11,036 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-28, les standards d'écriture adapotés par chaque communauté (langage/techno)
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 461,220 | 🐛 1,671 | 🌐 Python | 📅 2026-08-13, une collection d'API publiques classées par thématique. Magnifique travail
...
* [developer roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 364,595 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-14, un dépôt qui propose des chemins d'apprentissage pour les différents postes du web
* [gitignore](https://github.com/github/gitignore) ⭐ 175,301 | 🐛 83 | 📅 2026-07-23, une collection de templates pour vos fichiers `.gitignore`
* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,115 | 🐛 256 | 📅 2024-06-25, s'améliorer en ligne de commande
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 394,529 | 🐛 82 | 🌐 Python | 📅 2026-08-11,  un dépôt qui héberge une tonne de bouquins techniques au format PDF maintenu par la [Free Ebook Foundation](https://ebookfoundation.org/)
* [free-programming-books en français](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-fr.md) ⭐ 394,529 | 🐛 82 | 🌐 Python | 📅 2026-08-11, même dépôt que précédemment mais listant que des livres de programmation en français !
* [papers we love](https://github.com/papers-we-love/papers-we-love) ⭐ 108,787 | 🐛 2 | 🌐 Shell | 📅 2026-07-01, un dépôt recensant et hébergeant (quand c'est possible) tout un tas d'articles sur l'informatique. Recense également une collection de sites pour trouver des papiers intéressants à lire
...
* [CommunityWriterPrograms](https://github.com/malgamves/CommunityWriterPrograms) ⭐ 4,174 | 🐛 8 | 📅 2026-07-31, une liste de sites/éditeurs à qui vous pouvez soumettre des articles techniques contre rémunération
