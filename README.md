# Awesome Ressources gratuites pour les programmeur·euses, designeur·euses web, indépendant·es, bidouilleur·euses et autres intéressé·es with stars
...
* [simple.css](https://github.com/kevquirk/simple.css) ⭐ 4,984 | 🐛 0 | 🌐 HTML | 📅 2026-07-19, un template css sans classe pour prototyper un site markup stylé rapidement.
* [new.css](https://github.com/xz/new.css) ⭐ 4,044 | 🐛 37 | 🌐 HTML | 📅 2026-09-04, un framework css sans classe utilisant uniquement les sélecteurs de balise HTML et qui pèse 4.8kb
...
* [magic grid](https://github.com/e-oj/Magic-Grid) ⭐ 3,152 | 🐛 14 | 🌐 JavaScript | 📅 2024-09-04
...
* [App Doodler](https://doodler.copymyui.com/), un outil libre et gratuit pour créer des captures App Store multilingues à partir de mises en page et de traductions réutilisables
...
* [Devops exercises](https://github.com/bregman-arie/devops-exercises) ⭐ 84,368 | 🐛 55 | 🌐 Python | 📅 2025-12-27, une collection d'exercices et de corrigés sur de nombreux sujets et technologies
...
* [Interop](https://github.com/web-platform-tests/interop) ⭐ 515 | 🐛 71 | 🌐 JavaScript | 📅 2026-09-03, groupe de travail spécialisé dans l'interopérabilité entre les navigateurs (implémentations des standards du web). Ce groupe maintient notamment [une suite de tests cross-browsers](https://github.com/web-platform-tests/wpt) ⭐ 6,137 | 🐛 2,795 | 🌐 HTML | 📅 2026-09-05
...
* [DarkMoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 890 | 🐛 2 | 🌐 Python | 📅 2026-08-29, plateforme open source française de test d'intrusion autonome pilotée par IA et hébergée sur votre propre infrastructure. Elle couvre le web, les API, l'Active Directory et Kubernetes via un serveur MCP. Éditée en France par ASC IT.
...
* [Minix 3](https://www.minix3.org/), OS développé par [Tanenbaum](https://fr.wikipedia.org/wiki/Andrew_Tanenbaum) dont s'est inspiré Linus Torvalds pour créer le noyau Linux. OS destiné initialement à des fins pédagogiques, notamment *via* le fameux livre [Operating Systems Design and Implementation, 3rd edition](https://www.pearson.com/en-us/subject-catalog/p/operating-systems-design-and-implementation/P200000003167?view=educator)
...
* [W3C: Architecture of the World Wide Web, Volume One](https://www.w3.org/TR/2004/REC-webarch-20041215/), écrit par le *W3C Technical Architecture Group*
...
* [HAL Explorer](https://github.com/toedter/hal-explorer) ⭐ 177 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-04, with HAL Explorer you can browse and explore HAL and HAL-FORMS based RESTful Hypermedia APIs. HAL Explorer was inspired by Mike Kelly’s HAL-Browser. HAL Explorer also supports Spring Profiles.
...
* [phpCodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,779 | 🐛 248 | 🌐 PHP | 📅 2024-04-01, l'outil par excellence pour appliquer des standards de manière semiautomatisé à son code source. Composé de deux programmes: phpcs pour sniffer les erreurs dans votre code et phpcbs pour corriger automatiquement ce qui peut l'être.
...
[Voir le dépôt dédié à la veille PHP](https://github.com/paul-schuhm/veille-php) ⭐ 1 | 🐛 0 | 📅 2026-05-08.
...
* [Docker Bench for Security](https://github.com/docker/docker-bench-security) ⭐ 9,698 | 🐛 29 | 🌐 Shell | 📅 2026-06-04, ensemble de scripts open-source qui permet d'auditer de manière automatique l'installation et la configuration du serveur Docker en environnement de production
...
* [nomnoml](https://github.com/skanaar/nomnoml) ⭐ 2,836 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-19, un outil pour script le rendu de diagrammes UML
...
* [pspg - Postgres Pager](https://github.com/okbob/pspg) ⭐ 2,730 | 🐛 0 | 🌐 C | 📅 2026-08-30, pspg est un navigateur Unix pour naviguer dans les tables d'une base de données relationnelle
...
* [Software Architecture Premier](https://github.com/sivaprasadreddy/software-architecture-premier) ⭐ 610 | 🐛 0 | 📅 2024-08-22, liste de ressources pour apprendre l'architecture logicielle
...
* [Le Guide (fr)](https://github.com/bitemyapp/learnhaskell/blob/master/guide-fr.md) ⭐ 8,035 | 🐛 13 | 🌐 Makefile | 📅 2026-07-20
...
Et oui, [Rich Hickey](https://en.wikipedia.org/wiki/Rich_Hickey) a le droit à sa propre section. Allez directement voir [ce dépôt](https://github.com/tallesl/Rich-Hickey-fanclub) ⭐ 3,171 | 🐛 0 | 🌐 HTML | 📅 2025-02-09, le job est déjà fait avec talent pour recenser tous ses travaux.
...
* [CommonMark](https://commonmark.org/), [une spécification Markdown](https://spec.commonmark.org/) créée en 2004 par John Gruber et Aaron Swartz, [implémentée dans de nombreux langages de programmation](https://github.com/commonmark/commonmark-spec/wiki/List-of-CommonMark-Implementations) ⭐ 5,141 | 🐛 130 | 🌐 Python | 📅 2026-04-27
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,989 | 🐛 2 | 🌐 Vue | 📅 2026-09-05, bibliothèque open source pour afficher du Markdown en flux continu dans les interfaces de chat IA ; compatible avec Vue/Nuxt, React, Svelte, Angular et Vue 2, avec Mermaid, KaTeX et coloration syntaxique.
...
* [resume.md](https://github.com/mikepqr/resume.md) ⭐ 662 | 🐛 1 | 🌐 Python | 📅 2025-10-12, écrivez votre CV en Markdown, stylisez le en CSS, exportez le en PDF/HTML

## Écriture technique

### Outils d'écriture et de publication

* [typst](https://github.com/typst/typst) ⭐ 55,860 | 🐛 1,279 | 🌐 Rust | 📅 2026-09-03, langage markup destiné à produire des documents complets. Se place sur le même terrain que LaTeX.
...
* [Augmented Coding Patterns](https://lexler.github.io/augmented-coding-patterns/), une collection documentée de patterns dont s'inspirer dans un workflow basé sur l'interaction/intégration d'un LLM, guide/retex initialement écrit par [Lada Kesseler](https://github.com/lexler/augmented-coding-patterns) ⭐ 397 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-24;
...
* [Etudes for Programmers](https://github.com/archermarx/etudes/blob/main/Etudes%20for%20Programmers.pdf) ⭐ 21 | 🐛 0 | 🌐 Julia | 📅 2021-04-26, de Charles Wetherell, publié chez Prentice-Hall, 1978
...
* [tiny-gpu](https://github.com/adam-maj/tiny-gpu) ⭐ 12,916 | 🐛 43 | 🌐 SystemVerilog | 📅 2024-08-18, une implémentation GPU minimale pour apprendre le fonctionnement des GPU
* [Category Theory For Programmers](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,692 | 🐛 67 | 🌐 TeX | 📅 2026-07-10, de Bartosz Milewski
...
* [The Interfaces With Which We Think](https://alexanderobenauer.com/think/), d'Alexander Obenauer. Reflexion sur les abstractions avec lesquelles nous travaillons
...
* [Category Theory](https://www.youtube.com/watch?v=I8LbkfSSR58\&list=PLbgaMIhjbmEnaH_LTkxLI7FMa2HsnawM_), de Bartosz Milewski. Pour les programmeur·ses. Passionant ! [Voir le dépôt associé (livre)](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,692 | 🐛 67 | 🌐 TeX | 📅 2026-07-10
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 503,265 | 🐛 106 | 📅 2026-09-02, le dépôt originel des dépôts listant des bonnes ressources sur des sujets intéressants
...
* [design resources for developer](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,833 | 🐛 114 | 📅 2026-05-24
* [Design Resources for developers](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,833 | 🐛 114 | 📅 2026-05-24,  un autre dépôt maintenant une liste de ressources pour le design/composants web
* [Awesome Web Development Resources](https://github.com/markodenic/web-development-resources) ⭐ 8,088 | 🐛 14 | 🌐 JavaScript | 📅 2026-06-09, un dépôt impressionant (et mieux organisé que celui-ci) référençant des tonnes de ressources pour le développement web
* [awesome-learning-resources](https://github.com/lauragift21/awesome-learning-resources) ⭐ 5,766 | 🐛 28 | 📅 2025-07-16
* [Web Development Resources You Ever Need](https://github.com/iamismile/web-dev-resources) ⭐ 784 | 🐛 3 | 📅 2026-09-01, un dépôt maintenant une liste de ressources pour le développement web
* [Web development resources](https://github.com/MilanAryal/web-development-resources) ⭐ 221 | 🐛 22 | 📅 2024-08-10, un autre dépôt maintenant une liste de ressources pour le dev
...
* [Damn Vulnerable Web Application](https://github.com/digininja/DVWA) ⭐ 13,606 | 🐛 7 | 🌐 PHP | 📅 2026-08-19, une application web PHP/MySQL extrêmement vulnérable. Son objectif principal est d'aider les professionnels de la sécurité à tester leurs compétences et leurs outils dans un environnement légal, d'aider les développeurs web à mieux comprendre les processus de sécurisation des applications web et d'aider à la fois les étudiants et les enseignants à apprendre la sécurité des applications web dans un environnement de classe contrôlé.

### Outils "*no code*", "*low code*" ou plutot *visual code*

* [awesome-nocode-lowcode](https://github.com/valentin-vogel/awesome-nocode-lowcode) ⭐ 416 | 🐛 22 | 📅 2026-08-09

### Côté client (*Front-end*)

* [front end  checklist](https://github.com/thedaviddias/Front-End-Checklist) ⭐ 74,039 | 🐛 9 | 🌐 MDX | 📅 2026-08-14, liste tout ce que vous devez pensez à checker sur votre front avant d'envoyer en prod
* [frontend dev bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,471 | 🐛 133 | 📅 2024-05-21, une liste de ressources de qualité pour les développeurs frontend
* [css-protips](https://github.com/AllThingsSmitty/css-protips) ⭐ 30,262 | 🐛 1 | 📅 2026-08-24, un dépôt qui documente tout un tas de conseils pour le CSS avec exemples à l'appui
* [Frontend stuff](https://github.com/moklick/frontend-stuff) ⭐ 8,946 | 🐛 18 | 📅 2024-06-26, liste de tous les frameworks et libs côté client (CSS et JS surtout)
* [Jonas' Resources for Hand-Crafting Beautiful and Performant Websites](https://codingheroes.io/resources/)
* [omatsuri](https://omatsuri.app/)

### Développement de jeux vidéos

* [Magic tools](https://github.com/ellisonleao/magictools) ⭐ 17,252 | 🐛 14 | 🌐 Markdown | 📅 2026-09-01, un autre dépôt recenssant une tonne de ressources pour le développement de jeux vidéos (asset, code, design, outils, etc.)
* [GameDev Ressources](https://github.com/Kavex/GameDev-Resources) ⭐ 6,898 | 🐛 14 | 📅 2026-04-10, un dépôt recenssant une tonne de ressources pour le développement de jeux vidéos (asset, code, design, outils, etc.)
...
* [Awesome-Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 317,319 | 🐛 0 | 📅 2026-09-05, un dépôt qui liste des logiciels libres (free software) webs et réseau à herberger soi-même

### Conférences

* [awesome-talks](https://github.com/JanVanRyswyck/awesome-talks) ⭐ 6,201 | 🐛 30 | 📅 2026-08-26, un dépôt maintenant une liste de conférences tech, sacré taff
* [Developers Conferences Agenda/List](https://github.com/scraly/developers-conferences-agenda) ⭐ 2,000 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-05, agenda des conférences tech dans le monde
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,676 | 🐛 85 | 📅 2026-07-13, une liste organisée de ressources pour PHP (lib, books, podcasts, frameworks...)
...
* [awesome PHP security](https://github.com/guardrailsio/awesome-php-security) ⭐ 1,037 | 🐛 9 | 📅 2023-09-14, une liste organisée de ressources pour la sécurité des applications PHP
...
* [airbnb/javascript](https://github.com/airbnb/javascript) ⭐ 148,157 | 🐛 164 | 🌐 JavaScript | 📅 2026-04-16, le guide des bonnes pratiques JS d'airbnb
* [awesome-fp-js](https://github.com/stoeffel/awesome-fp-js) ⭐ 6,037 | 🐛 1 | 📅 2026-01-15, la même sur la programmation fonctionnelle
* [awesome-json](https://github.com/burningtree/awesome-json) ⭐ 1,564 | 🐛 100 | 📅 2026-06-19, la même sur des lib et ressources pour le json
...
* [awesome-typescript](https://github.com/dzharii/awesome-typescript) ⚠️ Archived, la même pour Typescript
...
* [wesome-nodejs-security](https://github.com/lirantal/awesome-nodejs-security) ⭐ 3,036 | 🐛 17 | 📅 2026-08-14, la même sur des ressources pour sécuriser ses projets node.js

#### Flutter

* [awesome-flutter](https://github.com/Solido/awesome-flutter) ⭐ 61,098 | 🐛 22 | 🌐 Dart | 📅 2026-09-03, un dépôt qui maintient une liste filtrée de ressources pour Flutter

### Projets open-source

* [awesomo](https://github.com/lk-geimfari/awesomo) ⭐ 9,933 | 🐛 11 | 🌐 Go | 📅 2026-06-04, une liste de projets open-source intéressants (notamment si on veut se mettre à contribuer à l'open source)

### Design et architecture logicielle

* [awesome-design-patterns](https://github.com/DovAmir/awesome-design-patterns) ⭐ 48,820 | 🐛 25 | 📅 2024-10-25, des solutions réutilisables face à des problèmes courants d'architecture logicielle
* [A comprehensive list of books on Software Architecture](https://github.com/mhadidg/software-architecture-books) ⭐ 11,332 | 🐛 3 | 📅 2023-03-15

### Apprendre

* [build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) ⭐ 545,405 | 🐛 641 | 🌐 Markdown | 📅 2026-07-14, des guides sélectionnés et corrigés pour recréer des logiciels que vous utilisez tous les jours (client BitTorrent, Bot, CLI, git, etc.). Vous permet de comprendre comment ces logiciels fonctionnent et d'apprendre des technos
* [The design system primer](https://github.com/donnemartin/system-design-primer) ⭐ 368,118 | 🐛 613 | 🌐 Python | 📅 2026-03-20, dépôt qui liste de nombreuses ressources pour apprendre à designer des systèmes informatiques sur le web. Focus sur la préparation aux entretiens
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 368,118 | 🐛 613 | 🌐 Python | 📅 2026-03-20, apprendre comment designer des grands systèmes d'information
* [project-based-learning](https://github.com/practical-tutorials/project-based-learning) ⭐ 282,185 | 🐛 278 | 🌐 Python | 📅 2026-08-31, une liste de tutoriels dans différents languages pour apprendre des technos sur des idées de projet
* [every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,387 | 🐛 25 | 📅 2025-12-29, un immense dépôt qui agrège une collection de savoirs techniques bon à connaître ou à découvrir lorsqu'on est développeur.
* [app-ideas](https://github.com/florinpop17/app-ideas) ⭐ 97,360 | 🐛 605 | 📅 2025-10-11, des idées d'applications à développer si on est en panne d'inspiration
* [professional-programming](https://github.com/charlax/professional-programming) ⭐ 51,485 | 🐛 7 | 🌐 Python | 📅 2026-07-15, collection de ressources pour apprendre sur tout un tas de sujets liés aux webs
* [awesome-guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 11,085 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-28, les standards d'écriture adapotés par chaque communauté (langage/techno)
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 475,802 | 🐛 1,902 | 🌐 Python | 📅 2026-09-02, une collection d'API publiques classées par thématique. Magnifique travail
* [markodenic/public-apis](https://github.com/markodenic/public-apis) ⭐ 205 | 🐛 4 | 🌐 HTML | 📅 2025-12-08, un autre dépôt listant des api publiques, par [Marko Denic](https://markodenic.com/)

### Divers

* [developer roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 366,363 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-04, un dépôt qui propose des chemins d'apprentissage pour les différents postes du web
* [gitignore](https://github.com/github/gitignore) ⭐ 175,610 | 🐛 74 | 📅 2026-09-04, une collection de templates pour vos fichiers `.gitignore`
* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,249 | 🐛 257 | 📅 2024-06-25, s'améliorer en ligne de commande
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,612 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-03, un template de départ professionnel pour vos fichiers html
* [big-list-of-naughty-string](https://github.com/minimaxir/big-list-of-naughty-strings) ⭐ 47,711 | 🐛 108 | 🌐 Python | 📅 2024-04-18, un dépôt qui recense toutes les chaînes de caractères qui pourraient poser problème quand elles entrent dans votre application
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 396,027 | 🐛 78 | 🌐 Python | 📅 2026-09-01,  un dépôt qui héberge une tonne de bouquins techniques au format PDF maintenu par la [Free Ebook Foundation](https://ebookfoundation.org/)
* [free-programming-books en français](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-fr.md) ⭐ 396,027 | 🐛 78 | 🌐 Python | 📅 2026-09-01, même dépôt que précédemment mais listant que des livres de programmation en français !
* [papers we love](https://github.com/papers-we-love/papers-we-love) ⭐ 109,472 | 🐛 4 | 🌐 Shell | 📅 2026-08-31, un dépôt recensant et hébergeant (quand c'est possible) tout un tas d'articles sur l'informatique. Recense également une collection de sites pour trouver des papiers intéressants à lire
* [techbooks](https://github.com/zouyanjian/techbooks/tree/master/history_books) ⭐ 92 | 🐛 0 | 📅 2013-07-17, un dépôt qui héberge une tonne de bouquins techniques au format PDF
...
* [CommunityWriterPrograms](https://github.com/malgamves/CommunityWriterPrograms) ⭐ 4,178 | 🐛 8 | 📅 2026-07-31, une liste de sites/éditeurs à qui vous pouvez soumettre des articles techniques contre rémunération
