...
* [simple.css](https://github.com/kevquirk/simple.css) ⭐ 4,978 | 🐛 0 | 🌐 HTML | 📅 2026-07-19, un template css sans classe pour prototyper un site markup stylé rapidement.
...
* [Devops exercises](https://github.com/bregman-arie/devops-exercises) ⭐ 84,178 | 🐛 55 | 🌐 Python | 📅 2025-12-27, une collection d'exercices et de corrigés sur de nombreux sujets et technologies
...
* [Interop](https://github.com/web-platform-tests/interop) ⭐ 506 | 🐛 46 | 🌐 JavaScript | 📅 2026-08-19, groupe de travail spécialisé dans l'interopérabilité entre les navigateurs (implémentations des standards du web). Ce groupe maintient notamment [une suite de tests cross-browsers](https://github.com/web-platform-tests/wpt) ⭐ 6,111 | 🐛 2,810 | 🌐 HTML | 📅 2026-08-20
...
* [DarkMoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 852 | 🐛 1 | 🌐 Python | 📅 2026-08-20, plateforme open source française de test d'intrusion autonome pilotée par IA et hébergée sur votre propre infrastructure. Elle couvre le web, les API, l'Active Directory et Kubernetes via un serveur MCP. Éditée en France par ASC IT.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,905 | 🐛 0 | 🌐 Vue | 📅 2026-08-20, bibliothèque open source pour afficher du Markdown en flux continu dans les interfaces de chat IA ; compatible avec Vue/Nuxt, React, Svelte, Angular et Vue 2, avec Mermaid, KaTeX et coloration syntaxique.
...
* [typst](https://github.com/typst/typst) ⭐ 55,541 | 🐛 1,278 | 🌐 Rust | 📅 2026-08-17, langage markup destiné à produire des documents complets. Se place sur le même terrain que LaTeX.
...
* [Augmented Coding Patterns](https://lexler.github.io/augmented-coding-patterns/), une collection documentée de patterns dont s'inspirer dans un workflow basé sur l'interaction/intégration d'un LLM, guide/retex initialement écrit par [Lada Kesseler](https://github.com/lexler/augmented-coding-patterns) ⭐ 388 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-08;
...
* [tiny-gpu](https://github.com/adam-maj/tiny-gpu) ⭐ 12,857 | 🐛 43 | 🌐 SystemVerilog | 📅 2024-08-18, une implémentation GPU minimale pour apprendre le fonctionnement des GPU
* [Category Theory For Programmers](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,679 | 🐛 67 | 🌐 TeX | 📅 2026-07-10, de Bartosz Milewski
...
* [Category Theory](https://www.youtube.com/watch?v=I8LbkfSSR58\&list=PLbgaMIhjbmEnaH_LTkxLI7FMa2HsnawM_), de Bartosz Milewski. Pour les programmeur·ses. Passionant ! [Voir le dépôt associé (livre)](https://github.com/hmemcpy/milewski-ctfp-pdf) ⭐ 11,679 | 🐛 67 | 🌐 TeX | 📅 2026-07-10
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,149 | 🐛 105 | 📅 2026-08-18, le dépôt originel des dépôts listant des bonnes ressources sur des sujets intéressants
...
* [design resources for developer](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,706 | 🐛 91 | 📅 2026-05-24
* [Design Resources for developers](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,706 | 🐛 91 | 📅 2026-05-24,  un autre dépôt maintenant une liste de ressources pour le design/composants web
* [Awesome Web Development Resources](https://github.com/markodenic/web-development-resources) ⭐ 8,085 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-09, un dépôt impressionant (et mieux organisé que celui-ci) référençant des tonnes de ressources pour le développement web
* [awesome-learning-resources](https://github.com/lauragift21/awesome-learning-resources) ⭐ 5,757 | 🐛 26 | 📅 2025-07-16
...
* [front end  checklist](https://github.com/thedaviddias/Front-End-Checklist) ⭐ 73,581 | 🐛 6 | 🌐 MDX | 📅 2026-08-14, liste tout ce que vous devez pensez à checker sur votre front avant d'envoyer en prod
* [frontend dev bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,402 | 🐛 133 | 📅 2024-05-21, une liste de ressources de qualité pour les développeurs frontend
* [css-protips](https://github.com/AllThingsSmitty/css-protips) ⭐ 30,255 | 🐛 2 | 📅 2025-03-20, un dépôt qui documente tout un tas de conseils pour le CSS avec exemples à l'appui
...
* [Magic tools](https://github.com/ellisonleao/magictools) ⭐ 17,164 | 🐛 13 | 🌐 Markdown | 📅 2026-08-17, un autre dépôt recenssant une tonne de ressources pour le développement de jeux vidéos (asset, code, design, outils, etc.)
...
* [Awesome-Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 313,908 | 🐛 0 | 📅 2026-08-20, un dépôt qui liste des logiciels libres (free software) webs et réseau à herberger soi-même
...
* [Developers Conferences Agenda/List](https://github.com/scraly/developers-conferences-agenda) ⭐ 1,997 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-20, agenda des conférences tech dans le monde
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,663 | 🐛 85 | 📅 2026-07-13, une liste organisée de ressources pour PHP (lib, books, podcasts, frameworks...)
...
* [airbnb/javascript](https://github.com/airbnb/javascript) ⭐ 148,124 | 🐛 163 | 🌐 JavaScript | 📅 2026-04-16, le guide des bonnes pratiques JS d'airbnb
* [awesome-fp-js](https://github.com/stoeffel/awesome-fp-js) ⭐ 6,035 | 🐛 1 | 📅 2026-01-15, la même sur la programmation fonctionnelle
* [awesome-json](https://github.com/burningtree/awesome-json) ⭐ 1,563 | 🐛 81 | 📅 2026-06-19, la même sur des lib et ressources pour le json
...
* [awesome-vue](https://github.com/vuejs/awesome-vue) ⭐ 73,537 | 🐛 96 | 📅 2026-07-24

#### Node.js

* [wesome-nodejs-security](https://github.com/lirantal/awesome-nodejs-security) ⭐ 3,025 | 🐛 9 | 📅 2026-08-14, la même sur des ressources pour sécuriser ses projets node.js

#### Flutter

* [awesome-flutter](https://github.com/Solido/awesome-flutter) ⭐ 60,961 | 🐛 38 | 🌐 Dart | 📅 2026-04-21, un dépôt qui maintient une liste filtrée de ressources pour Flutter

### Projets open-source

* [awesomo](https://github.com/lk-geimfari/awesomo) ⭐ 9,919 | 🐛 11 | 🌐 Go | 📅 2026-06-04, une liste de projets open-source intéressants (notamment si on veut se mettre à contribuer à l'open source)

### Design et architecture logicielle

* [awesome-design-patterns](https://github.com/DovAmir/awesome-design-patterns) ⭐ 48,630 | 🐛 25 | 📅 2024-10-25, des solutions réutilisables face à des problèmes courants d'architecture logicielle
* [A comprehensive list of books on Software Architecture](https://github.com/mhadidg/software-architecture-books) ⭐ 11,304 | 🐛 3 | 📅 2023-03-15

### Apprendre

* [build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) ⭐ 541,530 | 🐛 634 | 🌐 Markdown | 📅 2026-07-14, des guides sélectionnés et corrigés pour recréer des logiciels que vous utilisez tous les jours (client BitTorrent, Bot, CLI, git, etc.). Vous permet de comprendre comment ces logiciels fonctionnent et d'apprendre des technos
* [The design system primer](https://github.com/donnemartin/system-design-primer) ⭐ 365,071 | 🐛 608 | 🌐 Python | 📅 2026-03-20, dépôt qui liste de nombreuses ressources pour apprendre à designer des systèmes informatiques sur le web. Focus sur la préparation aux entretiens
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 365,071 | 🐛 608 | 🌐 Python | 📅 2026-03-20, apprendre comment designer des grands systèmes d'information
* [project-based-learning](https://github.com/practical-tutorials/project-based-learning) ⭐ 280,088 | 🐛 270 | 🌐 Python | 📅 2026-08-17, une liste de tutoriels dans différents languages pour apprendre des technos sur des idées de projet
* [every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,269 | 🐛 25 | 📅 2025-12-29, un immense dépôt qui agrège une collection de savoirs techniques bon à connaître ou à découvrir lorsqu'on est développeur.
* [app-ideas](https://github.com/florinpop17/app-ideas) ⭐ 96,946 | 🐛 606 | 📅 2025-10-11, des idées d'applications à développer si on est en panne d'inspiration
* [professional-programming](https://github.com/charlax/professional-programming) ⭐ 51,437 | 🐛 6 | 🌐 Python | 📅 2026-07-15, collection de ressources pour apprendre sur tout un tas de sujets liés aux webs
* [awesome-guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 11,048 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-28, les standards d'écriture adapotés par chaque communauté (langage/techno)
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 466,969 | 🐛 1,708 | 🌐 Python | 📅 2026-08-19, une collection d'API publiques classées par thématique. Magnifique travail
...
* [developer roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 364,997 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-20, un dépôt qui propose des chemins d'apprentissage pour les différents postes du web
* [gitignore](https://github.com/github/gitignore) ⭐ 175,381 | 🐛 84 | 📅 2026-07-23, une collection de templates pour vos fichiers `.gitignore`
* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,136 | 🐛 257 | 📅 2024-06-25, s'améliorer en ligne de commande
* [html5-boilerplate](https://github.com/h5bp/html5-boilerplate) ⭐ 57,598 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-10, un template de départ professionnel pour vos fichiers html
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 394,858 | 🐛 81 | 🌐 Python | 📅 2026-08-18,  un dépôt qui héberge une tonne de bouquins techniques au format PDF maintenu par la [Free Ebook Foundation](https://ebookfoundation.org/)
* [free-programming-books en français](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-fr.md) ⭐ 394,858 | 🐛 81 | 🌐 Python | 📅 2026-08-18, même dépôt que précédemment mais listant que des livres de programmation en français !
* [papers we love](https://github.com/papers-we-love/papers-we-love) ⭐ 108,875 | 🐛 3 | 🌐 Shell | 📅 2026-07-01, un dépôt recensant et hébergeant (quand c'est possible) tout un tas d'articles sur l'informatique. Recense également une collection de sites pour trouver des papiers intéressants à lire
...
* [CommunityWriterPrograms](https://github.com/malgamves/CommunityWriterPrograms) ⭐ 4,172 | 🐛 8 | 📅 2026-07-31, une liste de sites/éditeurs à qui vous pouvez soumettre des articles techniques contre rémunération
