...
* [Devops exercises](https://github.com/bregman-arie/devops-exercises) ⭐ 84,207 | 🐛 55 | 🌐 Python | 📅 2025-12-27, une collection d'exercices et de corrigés sur de nombreux sujets et technologies
...
* [Interop](https://github.com/web-platform-tests/interop) ⭐ 506 | 🐛 44 | 🌐 JavaScript | 📅 2026-08-19, groupe de travail spécialisé dans l'interopérabilité entre les navigateurs (implémentations des standards du web). Ce groupe maintient notamment [une suite de tests cross-browsers](https://github.com/web-platform-tests/wpt) ⭐ 6,113 | 🐛 2,827 | 🌐 HTML | 📅 2026-08-22
...
* [DarkMoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 857 | 🐛 1 | 🌐 Python | 📅 2026-08-21, plateforme open source française de test d'intrusion autonome pilotée par IA et hébergée sur votre propre infrastructure. Elle couvre le web, les API, l'Active Directory et Kubernetes via un serveur MCP. Éditée en France par ASC IT.
...
* [Markstream](https://github.com/Simon-He95/markstream-vue) ⭐ 2,946 | 🐛 0 | 🌐 Vue | 📅 2026-08-22, bibliothèque open source pour afficher du Markdown en flux continu dans les interfaces de chat IA ; compatible avec Vue/Nuxt, React, Svelte, Angular et Vue 2, avec Mermaid, KaTeX et coloration syntaxique.
...
* [typst](https://github.com/typst/typst) ⭐ 55,583 | 🐛 1,281 | 🌐 Rust | 📅 2026-08-21, langage markup destiné à produire des documents complets. Se place sur le même terrain que LaTeX.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,906 | 🐛 105 | 📅 2026-08-21, le dépôt originel des dépôts listant des bonnes ressources sur des sujets intéressants
...
* [design resources for developer](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,729 | 🐛 96 | 📅 2026-05-24
* [Design Resources for developers](https://github.com/bradtraversy/design-resources-for-developers) ⭐ 66,729 | 🐛 96 | 📅 2026-05-24,  un autre dépôt maintenant une liste de ressources pour le design/composants web
...
* [awesome-learning-resources](https://github.com/lauragift21/awesome-learning-resources) ⭐ 5,760 | 🐛 26 | 📅 2025-07-16
...
* [front end  checklist](https://github.com/thedaviddias/Front-End-Checklist) ⭐ 73,610 | 🐛 6 | 🌐 MDX | 📅 2026-08-14, liste tout ce que vous devez pensez à checker sur votre front avant d'envoyer en prod
* [frontend dev bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,409 | 🐛 133 | 📅 2024-05-21, une liste de ressources de qualité pour les développeurs frontend
* [css-protips](https://github.com/AllThingsSmitty/css-protips) ⭐ 30,252 | 🐛 2 | 📅 2025-03-20, un dépôt qui documente tout un tas de conseils pour le CSS avec exemples à l'appui
...
* [Magic tools](https://github.com/ellisonleao/magictools) ⭐ 17,177 | 🐛 14 | 🌐 Markdown | 📅 2026-08-17, un autre dépôt recenssant une tonne de ressources pour le développement de jeux vidéos (asset, code, design, outils, etc.)
* [GameDev Ressources](https://github.com/Kavex/GameDev-Resources) ⭐ 6,869 | 🐛 11 | 📅 2026-04-10, un dépôt recenssant une tonne de ressources pour le développement de jeux vidéos (asset, code, design, outils, etc.)
...
* [Awesome-Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 314,301 | 🐛 0 | 📅 2026-08-21, un dépôt qui liste des logiciels libres (free software) webs et réseau à herberger soi-même
...
* [Developers Conferences Agenda/List](https://github.com/scraly/developers-conferences-agenda) ⭐ 1,997 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-22, agenda des conférences tech dans le monde
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,666 | 🐛 86 | 📅 2026-07-13, une liste organisée de ressources pour PHP (lib, books, podcasts, frameworks...)
...
* [airbnb/javascript](https://github.com/airbnb/javascript) ⭐ 148,126 | 🐛 163 | 🌐 JavaScript | 📅 2026-04-16, le guide des bonnes pratiques JS d'airbnb
...
* [wesome-nodejs-security](https://github.com/lirantal/awesome-nodejs-security) ⭐ 3,025 | 🐛 11 | 📅 2026-08-14, la même sur des ressources pour sécuriser ses projets node.js

#### Flutter

* [awesome-flutter](https://github.com/Solido/awesome-flutter) ⭐ 60,976 | 🐛 39 | 🌐 Dart | 📅 2026-04-21, un dépôt qui maintient une liste filtrée de ressources pour Flutter

### Projets open-source

* [awesomo](https://github.com/lk-geimfari/awesomo) ⭐ 9,921 | 🐛 11 | 🌐 Go | 📅 2026-06-04, une liste de projets open-source intéressants (notamment si on veut se mettre à contribuer à l'open source)

### Design et architecture logicielle

* [awesome-design-patterns](https://github.com/DovAmir/awesome-design-patterns) ⭐ 48,645 | 🐛 25 | 📅 2024-10-25, des solutions réutilisables face à des problèmes courants d'architecture logicielle
...
* [build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) ⭐ 542,062 | 🐛 636 | 🌐 Markdown | 📅 2026-07-14, des guides sélectionnés et corrigés pour recréer des logiciels que vous utilisez tous les jours (client BitTorrent, Bot, CLI, git, etc.). Vous permet de comprendre comment ces logiciels fonctionnent et d'apprendre des technos
* [The design system primer](https://github.com/donnemartin/system-design-primer) ⭐ 365,431 | 🐛 612 | 🌐 Python | 📅 2026-03-20, dépôt qui liste de nombreuses ressources pour apprendre à designer des systèmes informatiques sur le web. Focus sur la préparation aux entretiens
* [system-design-primer](https://github.com/donnemartin/system-design-primer) ⭐ 365,431 | 🐛 612 | 🌐 Python | 📅 2026-03-20, apprendre comment designer des grands systèmes d'information
* [project-based-learning](https://github.com/practical-tutorials/project-based-learning) ⭐ 280,342 | 🐛 270 | 🌐 Python | 📅 2026-08-17, une liste de tutoriels dans différents languages pour apprendre des technos sur des idées de projet
* [every-programmer-should-know](https://github.com/mtdvio/every-programmer-should-know) ⭐ 100,276 | 🐛 25 | 📅 2025-12-29, un immense dépôt qui agrège une collection de savoirs techniques bon à connaître ou à découvrir lorsqu'on est développeur.
* [app-ideas](https://github.com/florinpop17/app-ideas) ⭐ 97,000 | 🐛 606 | 📅 2025-10-11, des idées d'applications à développer si on est en panne d'inspiration
* [professional-programming](https://github.com/charlax/professional-programming) ⭐ 51,442 | 🐛 6 | 🌐 Python | 📅 2026-07-15, collection de ressources pour apprendre sur tout un tas de sujets liés aux webs
* [awesome-guidelines](https://github.com/Kristories/awesome-guidelines) ⭐ 11,056 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-28, les standards d'écriture adapotés par chaque communauté (langage/techno)
...
* [public-apis](https://github.com/public-apis/public-apis) ⭐ 468,442 | 🐛 1,738 | 🌐 Python | 📅 2026-08-19, une collection d'API publiques classées par thématique. Magnifique travail
...
* [developer roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,147 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-21, un dépôt qui propose des chemins d'apprentissage pour les différents postes du web
* [gitignore](https://github.com/github/gitignore) ⭐ 175,404 | 🐛 81 | 📅 2026-07-23, une collection de templates pour vos fichiers `.gitignore`
* [the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,154 | 🐛 257 | 📅 2024-06-25, s'améliorer en ligne de commande
...
* [free-programming-books](https://github.com/EbookFoundation/free-programming-books) ⭐ 395,006 | 🐛 83 | 🌐 Python | 📅 2026-08-18,  un dépôt qui héberge une tonne de bouquins techniques au format PDF maintenu par la [Free Ebook Foundation](https://ebookfoundation.org/)
* [free-programming-books en français](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-fr.md) ⭐ 395,006 | 🐛 83 | 🌐 Python | 📅 2026-08-18, même dépôt que précédemment mais listant que des livres de programmation en français !
* [papers we love](https://github.com/papers-we-love/papers-we-love) ⭐ 108,921 | 🐛 3 | 🌐 Shell | 📅 2026-07-01, un dépôt recensant et hébergeant (quand c'est possible) tout un tas d'articles sur l'informatique. Recense également une collection de sites pour trouver des papiers intéressants à lire
